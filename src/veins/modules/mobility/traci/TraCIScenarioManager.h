...
protected:
    ...
    void addPedModule(std::string nodeId, std::string type, std::string name, std::string displayString, const Coord& position, std::string road_id = "", double speed = -1, Heading heading = Heading::nan);
    virtual void updateModulePositionPed(cModule* mod, const Coord& p, const std::string& edge, double speed, Heading heading);

    virtual void preInitializePedModule(cModule* mod, const std::string& nodeId, const Coord& position, const std::string& road_id, double speed, Heading heading);
